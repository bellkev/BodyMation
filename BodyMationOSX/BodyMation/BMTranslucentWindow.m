...
#import "BMTranslucentWindow.h"

@implementation BMTranslucentWindow
...
- (id)initWithContentRect:(NSRect)contentRect
    ...
    if (self != nil) {
        ...
        [self setBackgroundColor:[NSColor colorWithCalibratedWhite:0.0f alpha:0.7f]];
